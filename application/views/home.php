...
<body>
	<div class="container">
		...
		<form class="form-horizontal" method="post" action="/Users/process_registration" name="register"  >
		...
		<form class="form-horizontal" method="post" action="/Users/login_process" >
			<div class="form-group">
